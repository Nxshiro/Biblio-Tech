...
public class Recherche extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        String search = i.getStringExtra("recherche");
        RequestTask rt=new RequestTask();
        rt.execute(search);
    }


private class RequestTask extends AsyncTask<String, Void, ArrayList<Livre>> {
    // Le corps de la tâche asynchrone (exécuté en tâche de fond)
//  lance la requète

    private ArrayList<Livre> requete(String[] search) {
    ...
    @Override
    protected ArrayList<Livre> doInBackground(String... search) {
        ArrayList<Livre> response = requete(search);
        return response;
    }
